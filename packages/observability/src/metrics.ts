...
export class MetricsManager implements MetricRecorder {
  ...
  constructor(serviceName = 'agents-md-kit', serviceVersion = '1.0.0') {
   ...
   */
  recordValidationErrors(count: number, docType = 'unknown'): void {
   ...
   */
  recordValidationWarnings(count: number, docType = 'unknown'): void {
   ...
   */
  recordLintErrors(count: number, docType = 'unknown'): void {
   ...
   */
  recordLintWarnings(count: number, docType = 'unknown'): void {
   ...
   */
  recordFileProcessed(docType = 'unknown'): void {
