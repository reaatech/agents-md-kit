...
import { reportScaffoldResult } from '../../reporter/console-reporter.js';
import type { ScaffoldConfig } from '../../types/domain.js';
...
function buildScaffoldConfig(
  ...
  return {
    agentType: options.agentType as import('../../types/domain.js').AgentType,
